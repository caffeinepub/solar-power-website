...
import type { ExternalBlob as _ExternalBlob, GalleryItem as _GalleryItem, PmSuryaGharApplication as _PmSuryaGharApplication, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getApplicationStatus(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getPmSuryaGharApplicationById(arg0: bigint): Promise<PmSuryaGharApplication> {
        if (this.processError) {
            try {
                const result = await this.actor.getPmSuryaGharApplicationById(arg0);
                return from_candid_PmSuryaGharApplication_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPmSuryaGharApplicationsFiltered(arg0: string, arg1: string): Promise<Array<PmSuryaGharApplication>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPmSuryaGharApplicationsFiltered(arg0, arg1);
    ...
    async submitPmSuryaGharApplication(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob, arg4: ExternalBlob, arg5: ExternalBlob, arg6: ExternalBlob): Promise<{
        id: bigint;
        status: string;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPmSuryaGharApplication(arg0, arg1, arg2, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3), await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg4), await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg5), await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PmSuryaGharApplication_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PmSuryaGharApplication): Promise<PmSuryaGharApplication> {
...
async function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    phoneNumber: string;
    electricityBill: _ExternalBlob;
    bankPassbook: _ExternalBlob;
}): Promise<{
    id: bigint;
    passportPhoto: ExternalBlob;
    status: string;
    ...
    return {
        id: value.id,
        passportPhoto: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.passportPhoto),
        status: value.status,
        fullName: value.fullName,
        submittedBy: value.submittedBy,
        email: value.email,
        timestamp: value.timestamp,
        aadhaarCard: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.aadhaarCard),
        phoneNumber: value.phoneNumber,
        electricityBill: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.electricityBill),
        bankPassbook: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.bankPassbook)
    };
}
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PmSuryaGharApplication>): Promise<Array<PmSuryaGharApplication>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PmSuryaGharApplication_n18(_uploadFile, _downloadFile, x)));
}
